...
// try 블록에서 작성한 코드가 예외 발생 => catch 실행 o, finally 실행 o
// try, catch 블록에서 return 문을 사용해도 finally 실행딤(생략가능)
...
//            e.printStackTrace();
	...
	at _04_exception.ExceptionEx.main(ExceptionEx.java:25)
        ...
        ///////////////////////////////////
        // case 2. 예외 발생 코드
//        System.out.println("단어 길이 " + getLength(null)); // java.lang.NullpointException
...
//        System.out.println(getValueByIdx(numbers, numbers.length)); // java.lang.ArrayIndexOutOfBoundsException
        ...
        try {
            ...
            System.out.println("배열 인덱스 중 에러 발생 >> " + e.toString());
        }
